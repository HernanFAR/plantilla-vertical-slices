...
public interface ICreateRepository<TEntity>
{
    ...
    ValueTask<Result<TEntity>> CreateAsync(TEntity entity, CancellationToken cancellationToken = default);
}
...
public interface IRemoveRepository<TEntity>
{
    ...
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>A <see cref="ValueTask{T}"/> holding a <see cref="Result{TResponse}"/> of <see cref="Success"/> that represents the result of the operation </returns>
    ValueTask<Result<TEntity>> RemoveAsync(TEntity entity, CancellationToken cancellationToken = default);
}
...
{
    /// <summary>
    /// Queries data to response with a <see cref="Result{TResponse}"/>
    /// </summary>
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>A <see cref="ValueTask{T}"/> holding a <see cref="Result{TResponse}"/> of <see cref="Success"/> that represents the result of the operation </returns>
    ValueTask<Result<TDto>> ReadAsync(CancellationToken cancellationToken = default);
}
...
{
    /// <summary>
    /// Queries data using <typeparamref name="TSearchOptions"/> to response with a <see cref="Result{TResponse}"/>
    /// </summary>
    /// <param name="options"></param>
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>A <see cref="ValueTask{T}"/> holding a <see cref="Result{TResponse}"/> of <see cref="Success"/> that represents the result of the operation </returns>
    ValueTask<Result<TDto>> ReadAsync(TSearchOptions options, CancellationToken cancellationToken = default);
}
